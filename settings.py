...
# --- [수정] UI 위치 정의 (게임 영역 '안'으로) ---

# [수정] 점수 (게임 영역 좌측 상단)
# PLAY_AREA_RECT.left (82) + 20px 여백
# PLAY_AREA_RECT.top (111) + 15px 여백 (Y중심)
SCORE_POS = (PLAY_AREA_RECT.left + 20, PLAY_AREA_RECT.top + 15)

# [수정] 목숨 (게임 영역 우측 상단)
# 하트 3개 (너비 20*3 + 간격 5*2 = 70)
# PLAY_AREA_RECT.right (323) - 하트 3개(70) - 우측 여백(10) = 시작 X좌표 243
# Y좌표는 점수와 동일하게
LIVES_POS = (PLAY_AREA_RECT.right - 80, PLAY_AREA_RECT.top + 15)  # 80 = 하트 3개(70) + 여백(10)

# [유지] 하단 입력창 및 사자성어 위치 (게임 영역 하단 기준)
...
try:
    ...
    # [수정] 점수/목숨 UI가 게임 영역으로 들어갔으므로, 폰트 크기 다시 축소 (24 -> 15)
